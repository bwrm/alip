...
class ParcerView(CreateView, ParserI):
    ...
    def get_context_data(self, **kwargs):
        ...
        data = self.request.GET.get('articles', None)
        if data:
            context['data'] = self.get_data(data)
            context['articles'] = data.strip()
        return context


class OrderDetail(UpdateView, ParserI):
    template_name = 'edg/parcer.html'
    form_class = OrderForm
